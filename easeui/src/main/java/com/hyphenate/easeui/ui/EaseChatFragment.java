...
/**
 * you can new an EaseChatFragment to use or you can inherit it to expand. You need call setArguments to pass chatType
 * and userId <br/>
 * <br/>
...
//        if (chatType != EaseConstant.CHATTYPE_SINGLE)
    ...
    protected void onConversationInit() {
        ...
        if (null == conversation) {
            Toast.makeText(getActivity(), "username错误或网络连接失败", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    protected void addChatRoomChangeListenr() {
         ...
         * @Override public void onChatRoomDestroyed(String roomId, String roomName) { if
         * (roomId.equals(toChatUsername)) { showChatroomToast(" room : " + roomId + " with room name : " + roomName +
         * " was destroyed"); getActivity().finish(); } }
         * @Override public void onMemberJoined(String roomId, String participant) { showChatroomToast("member : " +
         * participant + " join the room : " + roomId); }
         ...
         * @Override public void onRemovedFromChatRoom(String roomId, String roomName, String participant) { if
         * (roomId.equals(toChatUsername)) { String curUser = EMClient.getInstance().getCurrentUser(); if
         * (curUser.equals(participant)) { EMClient.getInstance().chatroomManager().leaveChatRoom(toChatUsername);
         * getActivity().finish(); }else{ showChatroomToast("member : " + participant + " was kicked from the room : " +
         * roomId + " room name : " + roomName); } } } // ============================= group_reform new add api begin
         * @Override public void onMuteListAdded(String chatRoomId, Map<String, Long> mutes) {}
