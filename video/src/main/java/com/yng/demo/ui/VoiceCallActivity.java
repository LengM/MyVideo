...
import com.yng.demo.constant.CallActivity;
import com.yng.demo.constant.CallEvent;
...
public class VoiceCallActivity extends CallActivity {
     ...
     * 界面控件点击监听器
     */
    @OnClick({ R.id.btn_exit_full_screen, R.id.btn_mic_switch, R.id.btn_speaker_switch, R.id.btn_record_switch,
